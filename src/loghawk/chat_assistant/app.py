...
system_prompt = SystemMessagePromptTemplate.from_template(
    "You are an expert AI Cybersecurity assistant specializing in log analysis and security threat detection. Provide concise, correct solutions "
